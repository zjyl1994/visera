...
export function openDatabase(filename: string) {
  ...
  client.exec(`
    ...
    CREATE TABLE IF NOT EXISTS character_cards (id TEXT PRIMARY KEY, character_id TEXT, source_asset_ids TEXT, output_asset_id TEXT, prompt_version TEXT, model_name TEXT, status TEXT, is_default INTEGER DEFAULT 0, metadata_status TEXT DEFAULT 'pending', metadata TEXT, created_at INTEGER, updated_at INTEGER);
